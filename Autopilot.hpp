 ...
 * 
 * Rudder deflection must be in the range [-1, 1].  The Autopilot subclasses
 * will translate that into platform-specific units.  -1 is full left
 * deflection, and 1 is full right deflection.
 */
